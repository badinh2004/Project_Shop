                    ...
                    <div class="compare__section--inner table-responsive">
                        <table class="compare__table">
                            <thead class="compare__table--header">
                                <tr class="compare__table--items">
                                    <td class="compare__table--items__child">
                                        ...
                                        <img class="compare__product--thumb display-block" src="assets/img/product/product1.png" alt="compare-image">
                                    </td>
                                    <td class="compare__table--items__child">
                                        <button type="button" aria-label="compare remove btn" class="compare__remove">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                        ...
                                        <img class="compare__product--thumb display-block" src="assets/img/product/product2.png" alt="compare-image">
                                    </td>
                                    <td class="compare__table--items__child">
                                        <button type="button" aria-label="compare remove btn" class="compare__remove">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                        ...
                                        <h3 class="compare__product--title h4">Edna Dress</h3>
                                        <img class="compare__product--thumb display-block" src="assets/img/product/product3.png" alt="compare-image">
                                    </td>
                                    <td class="compare__table--items__child">
                                        <button type="button" aria-label="compare remove btn" class="compare__remove">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                        ...
                                        <h3 class="compare__product--title h4">Edna Dress</h3>
                                        <img class="compare__product--thumb display-block" src="assets/img/product/product4.png" alt="compare-image">
                                    </td>
                                    <td class="compare__table--items__child">
                                        <button type="button" aria-label="compare remove btn" class="compare__remove">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                        ...
                                        <h3 class="compare__product--title h4">Edna Dress</h3>
                                        <img class="compare__product--thumb display-block" src="assets/img/product/product5.png" alt="compare-image">
                                    </td>
                                </tr>
                            </thead>
                            <tbody class="compare__table--body">
                                ...
                                <tr class="compare__table--items">
                                    <td class="compare__table--items__child">
                                        <a class="compare__cart--btn btn" href="cart.html">Add to Cart</a>
                                    </td>
                                    <td class="compare__table--items__child">
                                        <a class="compare__cart--btn btn" href="cart.html">Add to Cart</a>
                                    </td>
