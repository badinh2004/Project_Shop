                                ...
                                <div class="row  align-items-center">
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                        <div class="slider__content2">
                                            <span class="slider__content2--subtitle">{{$item->title}}</span>
                                            <h2 class="slider__content2--maintitle h1">{{$item->description}}</h2>   
                                            <a class="btn slider__btn" href="{{ route('shop') }}">Shop Now</a>
                                        </div>
                                    </div>
                                    <div class="col-xl-7 col-lg-6 col-md-6">
                                        <div class="hero__slider--layer text-right">
                                            <img class="slider__layer--img" src="{{ asset('storage/images/' . $item->image) }}" alt="slider-img">
                                        </div>
                                    </div>
                                </div>
                            </div>
