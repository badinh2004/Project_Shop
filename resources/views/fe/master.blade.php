                    ...
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="offcanvas__sub_menu_li"><a href="{{ route('logout')}}" class="offcanvas__sub_menu_item">Logout</a></li>
                                    
                                @else
                                <li class="offcanvas__sub_menu_li"><a href="{{ route('login')}}" class="offcanvas__sub_menu_item">Login Page</a></li>
                                @endif
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        ...
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="{{ route('login')}}">Login Page</a></li>
