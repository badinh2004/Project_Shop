    ...
    <header class="header__section header__transparent">
        ...
        <div class="offCanvas__minicart">
            ...
            <div class="minicart__amount">
                ...
                {{-- <div class="minicart__amount_list d-flex justify-content-between">
                    <span>VAT 5%:</span>
                    <span><b>${{ ($item->ToTalPrice * 5) / 100 }}</b></span>
                </div> --}}
                <div class="minicart__amount_list d-flex justify-content-between">
                    <span>Total:</span>
                    <span class="text-danger"><b>${{ $item->ToTalPrice }}</b></span>
                    {{-- <span class="text-danger"><b>${{ $item->ToTalPrice + ($item->ToTalPrice * 5) / 100 }}</b></span> --}}
                </div>
            </div>
